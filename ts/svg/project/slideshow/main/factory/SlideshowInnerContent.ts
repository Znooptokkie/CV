...
export class SlideshowInnerContent
{
    ...
    public drawInnerContentBorder(): void
    {
        ...
        this.addInnerMaskToDefs("battlebot")
        this.addMaskedImage("battlebot")
    ...
    public addMaskedImage(projectName: string)
    {
        const { svg } = this.context
    
        new SVGFactory(svg.svg, "image", {
            href: `../static/images/projects/battlebot/battelbot_frontview.webp`,
            x: 0,
            y: 0,
            width: this.context.svg.viewboxWidth,
            height: this.context.svg.viewboxHeight,
